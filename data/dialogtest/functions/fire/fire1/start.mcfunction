...
data modify storage dialogtest:story run.villager set value [{t:745,type:"fn",fn:"dialogtest:fire/fire1/villager_walk_to_dest1"},{t:905,type:"fn",fn:"dialogtest:fire/fire1/villager_walk_to_dest2"}]
