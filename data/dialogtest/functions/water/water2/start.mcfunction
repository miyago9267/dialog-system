...
data modify storage dialogtest:story run.text set value [{t:25,type:"text",key:"story.water.water2.line1"},{t:105,type:"text",key:"story.water.water2.line2"},{t:185,type:"text",key:"story.water.water2.line3"},{t:265,type:"text",key:"story.water.water2.line4"},{t:345,type:"text",key:"story.water.water2.line5"},{t:425,type:"text",key:"story.water.water2.line6"},{t:505,type:"text",key:"story.water.water2.line7"},{t:585,type:"text",key:"story.water.water2.line8"},{t:665,type:"text",key:"story.water.water2.line9"},{t:745,type:"text",key:"story.water.water2.line10"}]

# action 軌（AJ 動畫與攝影機動作）
data modify storage dialogtest:story run.action set value [{t:105,type:"anim_trs",tag:"union",from:"breath",to:"sidehead"},{t:205,type:"anim_trs",tag:"union",from:"sidehead",to:"breath"},{t:185,type:"anim_trs",tag:"watergod",from:"breath",to:"give"},{t:185,type:"fn",fn:"dialogtest:water/water2/act2"},{t:295,type:"anim_trs",tag:"watergod",from:"give",to:"breath"},{t:345,type:"fn",fn:"dialogtest:water/water2/act3"},{t:665,type:"anim_trs",tag:"watergod",from:"breath",to:"nod"},{t:685,type:"anim_trs",tag:"watergod",from:"nod",to:"breath"}]
# act1 (t=60): 尤尼恩歪頭
...
data modify storage dialogtest:story run.ctrl set value [{t:785,type:"fn",fn:"dialogtest:operations/transition/fade_to_black"},{t:825,type:"fn",fn:"dialogtest:water/water2/cleanup"}]
