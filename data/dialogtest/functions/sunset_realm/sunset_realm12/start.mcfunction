...
data modify storage dialogtest:story run.text set value [{t:25,type:"text",key:"story.sunset_realm.sunset_realm12.line1"},{t:65,type:"text",key:"story.sunset_realm.sunset_realm12.line2"},{t:105,type:"text",key:"story.sunset_realm.sunset_realm12.line3"}]
