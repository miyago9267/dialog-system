...
data modify storage dialogtest:story run.action set value [{t:25,type:"anim_trs",tag:"lightgod",from:"breath",to:"nod"},{t:45,type:"anim_trs",tag:"lightgod",from:"nod",to:"breath"},{t:185,type:"anim_trs",tag:"lightgod",from:"breath",to:"give"},{t:295,type:"anim_trs",tag:"lightgod",from:"give",to:"breath"},{t:425,type:"anim_trs",tag:"lightgod",from:"breath",to:"kick"},{t:435,type:"anim_trs",tag:"lightgod",from:"kick",to:"breath"}]
# act1 (t=0): 光神點頭
# act2 (t=120): 光神抬手
