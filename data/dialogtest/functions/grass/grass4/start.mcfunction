...
summon text_display -945 8 1922 {text:'{"text":"木神","color":"white","bold":true}',billboard:"center",Tags:["grass4_entity"]}
...
data modify storage dialogtest:story run.text set value [{t:0,type:"text",key:"story.grass.grass4.line1"},{t:60,type:"text",key:"story.grass.grass4.line2"},{t:120,type:"text",key:"story.grass.grass4.line3"},{t:180,type:"text",key:"story.grass.grass4.line4"},{t:240,type:"text",key:"story.grass.grass4.line5"},{t:300,type:"text",key:"story.grass.grass4.line6"},{t:360,type:"text",key:"story.grass.grass4.line7"},{t:420,type:"text",key:"story.grass.grass4.line8"}]

# action 軌（AJ 動畫與攝影機動作）
data modify storage dialogtest:story run.action set value [{t:0,type:"anim_trs",tag:"woodgod",from:"breath",to:"nod"},{t:30,type:"anim_trs",tag:"woodgod",from:"nod",to:"breath"},{t:60,type:"anim_trs",tag:"woodgod",from:"breath",to:"nod"},{t:90,type:"anim_trs",tag:"woodgod",from:"nod",to:"breath"},{t:120,type:"anim_trs",tag:"woodgod",from:"breath",to:"give"},{t:120,type:"fn",fn:"dialogtest:grass/grass4/act3"},{t:150,type:"anim_trs",tag:"woodgod",from:"give",to:"breath"},{t:300,type:"fn",fn:"dialogtest:grass/grass4/act4"}]
# act1 (t=0): 木神點頭
# act2 (t=60): 木神點頭
...
data modify storage dialogtest:story run.ctrl set value [{t:480,type:"fn",fn:"dialogtest:grass/grass4/cleanup"}]
