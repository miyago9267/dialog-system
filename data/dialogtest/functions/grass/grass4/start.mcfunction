...
data modify storage dialogtest:story run.text set value [{t:25,type:"text",key:"story.grass.grass4.line1"},{t:85,type:"text",key:"story.grass.grass4.line2"},{t:145,type:"text",key:"story.grass.grass4.line3"},{t:205,type:"text",key:"story.grass.grass4.line4"},{t:265,type:"text",key:"story.grass.grass4.line5"},{t:325,type:"text",key:"story.grass.grass4.line6"},{t:385,type:"text",key:"story.grass.grass4.line7"},{t:445,type:"text",key:"story.grass.grass4.line8"}]

# action 軌（AJ 動畫與攝影機動作）
data modify storage dialogtest:story run.action set value [{t:25,type:"anim_trs",tag:"woodgod",from:"breath",to:"nod"},{t:55,type:"anim_trs",tag:"woodgod",from:"nod",to:"breath"},{t:85,type:"anim_trs",tag:"woodgod",from:"breath",to:"nod"},{t:115,type:"anim_trs",tag:"woodgod",from:"nod",to:"breath"},{t:145,type:"anim_trs",tag:"woodgod",from:"breath",to:"give"},{t:145,type:"fn",fn:"dialogtest:grass/grass4/act3"},{t:175,type:"anim_trs",tag:"woodgod",from:"give",to:"breath"},{t:325,type:"fn",fn:"dialogtest:grass/grass4/act4"}]
# act1 (t=0): 木神點頭
# act2 (t=60): 木神點頭
...
data modify storage dialogtest:story run.ctrl set value [{t:485,type:"fn",fn:"dialogtest:operations/transition/fade_to_black"},{t:505,type:"fn",fn:"dialogtest:grass/grass4/cleanup"}]
